...
import 'package:usuario/bienvenida.dart';
    ...
    return Scaffold(
      ...
      body: Container(
        decoration: BoxDecoration(
          color: Color.fromARGB(200, 300, 215, 355),
        ),
        child: Column(
            ...
            Padding(
              ...
              child: ElevatedButton.icon(
                ...
                onPressed: () {
                  ...
                  String validUsername = "oscar fernando";
                  ...
                  if (username == validUsername && password == validPassword) {
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => Bienvenida(usuarioValido: true, username: username),
                      ),
                    );
                  } else {
